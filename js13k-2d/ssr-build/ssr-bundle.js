...
var Footer = function Footer(_ref2) {
    ...
    return (0, _preact.h)(
        'footer',
        { 'class': 'footer' },
        (0, _preact.h)(Stat2, { title: 'fps', value: Math.round(fps) }),
        (0, _preact.h)(Stat2, { title: 'ms', value: ms.toFixed(1) }),
        stats.map(function (_ref3) {
            var title = _ref3.title,
                value = _ref3.value;
            return (0, _preact.h)(Stat2, { title: title, value: value });
        })
    );
};

var Stat = function Stat(_ref4) {
...
var Stats = function Stats(_ref5) {
    var fps = _ref5.fps,
        ms = _ref5.ms,
        stats = _ref5.stats;
    return (0, _preact.h)(
        'div',
        { id: 'stats' },
        (0, _preact.h)(Stat, { title: 'fps', value: Math.round(fps) }),
        (0, _preact.h)(Stat, { title: 'ms', value: ms.toFixed(1) }),
        stats.map(function (_ref6) {
            var title = _ref6.title,
                value = _ref6.value;
            return (0, _preact.h)(Stat, { title: title, value: value });
        })
    );
};

var _ref8 = (0, _preact.h)(_header2.default, null);

var _ref9 = (0, _preact.h)(_profile2.default, { path: '/profile/', user: 'me' });

var _ref10 = (0, _preact.h)(_profile2.default, { path: '/profile/:user' });
...
var App = function (_Component) {
    ...
    App.prototype.render = function render(props, _ref7) {
        var fps = _ref7.fps,
            ms = _ref7.ms,
            stats = _ref7.stats,
            loop = _ref7.loop;
        ...
        return (0, _preact.h)(
            ...
            (0, _preact.h)(
                ...
                (0, _preact.h)(_home2.default, { path: '/', start: this.start }),
                _ref9,
                _ref10
            ),
